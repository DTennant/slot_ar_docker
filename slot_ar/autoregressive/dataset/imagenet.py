...
class CustomWoofDataset(Dataset):
    def __init__(self, code_path):
        self.codes = torch.load(code_path)
        self.features = self.codes['nearest_centroids']
        self.labels = self.codes['class_labels']
        self.flip = False
...
def build_imagewoof_code(args):
    codes_path = f"{args.code_path}"
    return CustomWoofDataset(codes_path)