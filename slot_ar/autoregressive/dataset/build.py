from dataset.imagenet import build_imagenet, build_imagenet_code, build_imagewoof_code
...
def build_dataset(args, **kwargs):
    ...
    if args.dataset == 'imagewoof_code':
        return build_imagewoof_code(args, **kwargs)
